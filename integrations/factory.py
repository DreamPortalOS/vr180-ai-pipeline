...
# pulling in heavy dependencies at import time.
...
def _ensure_registry() -> None:
    ...
    _PROVIDER_REGISTRY["local-svd"] = LocalSVDProvider
    _PROVIDER_REGISTRY["minimax"] = MiniMaxProvider
...
def get_provider(name: str, **kwargs: Any) -> VideoGenProvider:
    ...
    ----------
    name : str
        One of ``"kling"``, ``"minimax"``, ``"seedance"``, ``"veo"``,
        ``"local-svd"``, ``"mock"``.
    **kwargs
